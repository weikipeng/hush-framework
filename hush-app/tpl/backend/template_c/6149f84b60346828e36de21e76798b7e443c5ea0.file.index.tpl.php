...
<?php if (!is_callable('smarty_modifier_date_format')) include 'D:\workspace\apps\lib\Smarty_3\plugins\modifier.date_format.php';
...
?><img src="<?php echo $_smarty_tpl->getVariable('_root')->value;?>
img/icon_man.png" class="icon" /> <?php echo $_smarty_tpl->tpl_vars['priv']->value;?>
 <?php }} ?></li>
		<li><img src="<?php echo $_smarty_tpl->getVariable('_root')->value;?>
