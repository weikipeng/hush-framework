...
<?php /*%%SmartyHeaderCode:35114c0cca8bb5ca32-32865820%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '35114c0cca8bb5ca32-32865820',
  'function' => 
  array (
  ),
...
if (count($_from) > 0){
    foreach ($_from as $_smarty_tpl->tpl_vars['option']->key => $_smarty_tpl->tpl_vars['option']->value){
?>
				<?php if ($_smarty_tpl->tpl_vars['option']->value['readonly']){?>
					<optgroup label="<?php echo $_smarty_tpl->tpl_vars['option']->value['name'];?>
 *"></optgroup>
				<?php }else{ ?>
					<option value="<?php echo $_smarty_tpl->tpl_vars['option']->value['id'];?>
"><?php echo $_smarty_tpl->tpl_vars['option']->value['name'];?>
